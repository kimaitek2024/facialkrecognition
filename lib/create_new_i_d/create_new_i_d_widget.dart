...
import 'create_new_i_d_model.dart';
export 'create_new_i_d_model.dart';

class CreateNewIDWidget extends StatefulWidget {
  const CreateNewIDWidget({super.key});

  @override
  State<CreateNewIDWidget> createState() => _CreateNewIDWidgetState();
}

class _CreateNewIDWidgetState extends State<CreateNewIDWidget> {
  late CreateNewIDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateNewIDModel());
    ...
    _model.guardianNameFocusNode!.addListener(() => setState(() {}));
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor: (_model.guardianNameFocusNode
                                                    ?.hasFocus ??
                                                false)
                                            ? FlutterFlowTheme.of(context)
                                                .accent1
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await sTudentsRecordReference
                          ...
                          email:
                              '${random_data.randomInteger(6, 10).toString()}@aanp.com',
                          ...
                          guardianName: _model.dateOfBirthTextController1.text,
                          status: true,
                          gender: _model.choiceChipsValue,
                        ));
                        _model.studentss = STudentsRecord.getDocumentFromData(
