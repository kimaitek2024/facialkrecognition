...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'CreateNewID',
          path: '/createNewID',
          builder: (context, params) => const CreateNewIDWidget(),
        ),
        FFRoute(
          name: 'addPhoto',
          path: '/addPhoto',
        ...
        FFRoute(
          name: 'PreviewID',
          path: '/previewID',
          builder: (context, params) => const PreviewIDWidget(),
        ),
        FFRoute(
          name: 'StudentsList',
          path: '/studentsList',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'StudentsList')
          ...
          final child = appStateNotifier.loading
              ? isWeb
                  ...
                  : Container(
                      ...
                      child: Center(
                        child: Image.asset(
                          'assets/images/77b00327-24a0-49ce-9d9e-85473543b19e-removebg-preview.png',
                          width: 300.0,
                          height: 300.0,
                          fit: BoxFit.cover,
                        ),
